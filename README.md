...
Laravel Bootstrap Breeze is open-sourced software licensed under the [MIT license](LICENSE.md).
Laravel Breeze is open-sourced software licensed under the [MIT license](https://github.com/laravel/breeze/blob/1.x/LICENSE.md).
